...
["", "piratetag.dart", , K, {
  ...
  main: [function() {
    ...
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(K.updateBadge$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = document.querySelector("#generateNameButton");
    $.genButton = t1;
    t1 = J.get$onClick$x(t1);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(K.generateName$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  ...
  updateBadge: [function(e) {
    ...
    t1 = K.PirateName$(null, inputName);
    ...
    if (t1.length === 0) {
      ...
      t2.textContent = "Capn's choice";
    } else {
      J.set$disabled$x(t2, true);
      t2.textContent = "I know yer name";
    }
  }, "call$1", "updateBadge$closure", 2, 0, 6],
  generateName: [function(e) {
    var t1, t2, t3;
    t1 = K.PirateName$(null, null);
    t2 = document.querySelector("#badgeName");
    t3 = t1._firstName;
    t2.textContent = t3.length === 0 ? "" : t3 + " the " + t1._appellation;
  }, "call$1", "generateName$closure", 2, 0, 6],
  PirateName: {
    ...
    PirateName$2$appellation$firstName: function(appellation, firstName) {
      ...
      if (firstName == null) {
        ...
        t2 = $.get$PirateName_indexGen().nextInt$1(14);
        if (t2 < 0 || t2 >= 14)
          return H.ioore(t1, t2);
      ...
      t2 = $.get$PirateName_indexGen().nextInt$1(20);
      if (t2 < 0 || t2 >= 20)
        return H.ioore(t1, t2);
    ...
    static: {"^": "PirateName_indexGen,PirateName_names,PirateName_appellations", PirateName$: function(appellation, firstName) {
        var t1 = new K.PirateName(null, null);
...
Isolate.$lazy($, "names", "PirateName_names", "get$PirateName_names", function() {
  return ["Tyler", "Kim", "Alek", "Meg", "Corinne", "Brittany", "Dan", "Stefan", "Andrew", "Will", "Angie", "Emily", "Noah", "Brian"];
});
Isolate.$lazy($, "appellations", "PirateName_appellations", "get$PirateName_appellations", function() {
  return ["Jackal", "King", "Red", "Stalwart", "Young", "Brave", "Eager", "Wily", "Zesty", "Speedy", "Bumbling", "Stumbling", "Queen", "Sleepy", "Master", "Trainer", "Forgotten", "Revered", "Indecisive", "Turtle"];
});
...
//# sourceMappingURL=piratetag.js.map
